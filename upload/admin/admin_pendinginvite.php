...
if ($action == "pendinginvite")
{
  ...
  //  $count = get_row_count("users", "WHERE status = 'pending' AND invited_by != '0'");
    ...
    list($pagertop, $pagerbottom, $limit) = pager(25, $count, '/admincp?action=pendinginvite&amp;');  
    ...
    <tr>
        ...
        <td class="table_col2" align="center"><a href="<?php echo TTURL; ?>/users/profile?id=<?php echo $row["invited_by"]; ?>"><?php echo $row["inviter"]; ?></a></td>
