...
if ($action=="lastcomm"){
	...
	while ($arr = $res->fetch(PDO::FETCH_ASSOC)) {
        ...
        $type = 'Torrent: <a href="torrents/details?id='.$tid.'">'.$title.'</a>';
