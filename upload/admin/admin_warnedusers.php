...
if ($action == "warned")
{
    ...
    <tr>
        <td class="table_col1" align="center"><a href="<?php echo TTURL; ?>/users?id=<?php echo $row["id"]; ?>"><?php echo class_user($row["username"]); ?></a></td>
        ...
        <td class="table_col1" align="center"><a href="<?php echo TTURL; ?>/users?id=<?php echo $row["id"]; ?>#warnings"><?php echo number_format(get_row_count("warnings", "WHERE userid = '$row[id]' AND active = 'yes'")); ?></a></td>
