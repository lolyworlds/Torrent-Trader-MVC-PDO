<?php
#================================#
#    TorrentTrader 2.08 PHP7 MM  #
#  https://www.torrenttrader.org #
#================================#
	...
	<?php
			...
			<table border="0" class="table_table" cellpadding="4" cellspacing="0" width="100%">
					...
					<tr align="center">  <!-- below was ".(count($expandrows)?" -->
						<?php echo("<td class='ttable_col1' align='left' nowrap='nowrap'>".($expandrows?"<a href=\"javascript: klappe_torrent('t".$row['0']."')\"><img border=\"0\" src=\"".$site_config["SITEURL"]."/images/plus.gif\" id=\"pict".$row['0']."\" alt=\"Show/Hide\" class=\"showthecross\" /></a>":"")."<a title=\"".$row["1"]."\" href=\"torrents-details.php?id=".$row['0']."&amp;hit=1\"><b>$smallname</b></a> $freeleech</td>"); ?>
					  <?php if ($site_config["ALLOWEXTERNAL"]) { ?>
