...
public function getTorrentByCat ($where, $parent_check, $orderby, $limit) 
{
    $row = $this->db->run("
	SELECT 
	torrents.id, torrents.anon, torrents.announce, torrents.tube,  torrents.imdb, torrents.category, torrents.leechers, torrents.nfo, torrents.seeders, torrents.name, torrents.times_completed, 
...
public function getCatSortAll($where, $date_time, $orderby, $limit)
{
    $row = $this->db->run("
    SELECT 
    torrents.id, torrents.anon, torrents.category, torrents.imdb, torrents.tube, torrents.tube, torrents.leechers, torrents.nfo, torrents.seeders, torrents.name, torrents.times_completed, torrents.size, 
