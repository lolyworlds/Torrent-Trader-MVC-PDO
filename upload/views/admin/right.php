...
<div class="border border-primary">
    <ul class="list-group">
    <li class="list-group-item"><a href="<?php echo TTURL; ?>/admincp?action=seedbonus"><img src="images/admin/seedbonus.png" border="0" width="20" height="20" alt="" />&nbsp;<b>Management of Seed Bonus</b></a></li>
