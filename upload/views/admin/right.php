...
<div class="border border-primary"> 
    ...
    <li class="list-group-item"><a href="<?php echo TTURL; ?>/admincp?action=seedbonus"><img src="images/admin/seedbonus.png" border="0" width="20" height="20" alt="" />&nbsp;<b>Seed Bonus</b></a></li>
