	...
	if ($config["imdb"]) {
        print("<tr><td align='right'>" . T_("IMDB") . ": </td><td align='left'> <input type='text' name='imdb' size='60' value='" . $_POST['imdb'] . "' /><br>(Link from IMDB.)</td></tr>");
    }
	if ($config["youtube"]) {
        print("<tr><td align=right>".T_("VIDEOTUBE").": </td><td align=left><input type='text' name='tube' size='50' />&nbsp;<a href=\"http://www.youtube.com\" target='_blank'><img border='0' src='$config[SITEURL]/images/youtube.png' width='50' height='50' title='Click here to go to Youtube'></a><br/><i>".T_("FORMAT").": </i> <span style='color:#FF0000'><b> https://www.youtube.com/watch?v=aYzVrjB-CWs</b></SPAN></td></tr>");
	}	
	print ("<tr><td colspan='2' align='center'>".T_("MAX_FILE_SIZE").": ".mksize($config['image_max_filesize'])."&nbsp;".T_("ACCEPTED_FORMATS").": ".implode(", ", array_unique($config["allowed_image_types"]))."<br /></td></tr><tr><td align='right'>".T_("IMAGE")." 1:&nbsp;&nbsp;</td><td><input type='file' name='image0' size='50' /></td></tr><tr><td align='right'>".T_("IMAGE")." 2:&nbsp;&nbsp;</td><td><input type='file' name='image1' size='50' /></td></tr>");
