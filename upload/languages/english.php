...
$LANG["ACCOUNT_BEFOR_USING_REST"] = "we urge you to read the <a href='$config[SITEURL]/faq'><b>FAQ</b></a>.</p>";
...
$LANG["REPORT_MEMBER_MSG"] = "<b>This member has elected to keep their details private</b><br /><br /><a href='$config[SITEURL]/report/user?user=%s'>Report.</a><br />";
...
$LANG["THEME_NOTHING_SELECTED"] = "Nothing Selected.<br /><a href='$config[SITEURL]/admincp?action=style'>Click Here</a> to go back or wait 3 seconds to be redirected.";
...
$LANG["FORUM_RULES2"] = "Please do try not to discuss upload/release-specific stuff here, post a torrent comment instead!<br /><br /><b>Please make sure to read the <a href='$config[SITEURL]/rules'>rules</a> before you post</b>";

$LANG["FORUMS_DEL_POST"] = "Delete post";
$LANG["FORUMS_DEL_POST_ONLY_POST"] = "Can't delete post; it is the only post of the topic. You should <a href='$config[SITEURL]/forums/deletetopic&amp;topicid=%s&amp;sure=1'>delete the topic</a> instead.\n";
$LANG["FORUMS_DEL_POST_SANITY_CHK"] = "Sanity check: You are about to delete a post. Click <a href='$config[SITEURL]/forums/deletepost&amp;postid=%s&amp;sure=1'>here</a> if you are sure.";
$LANG["FORUMS_DEL_TOPIC"] = "Delete topic";
$LANG["FORUMS_DEL_TOPIC_SANITY_CHK"] = "Sanity check: You are about to delete a topic. Click <a href='$config[SITEURL]/forums/deletetopic&amp;topicid=%s&amp;sure=1'>here</a> if you are sure.";
...
$LANG["TORRENT_UPLOAD_EXTERNAL"] = "Torrent Uploaded OK:<br /><br />%s was uploaded.<br /><br /><a href='$config[SITEURL]/torrents/read?id=%d'>View Uploaded Torrent</a><br /><br />";
$LANG["TORRENT_UPLOAD_LOCAL"] = "Torrent Uploaded OK:<br /><br />%s was uploaded.<br /><br />  Please remember to re-download so that your passkey is added and you can seed this torrent.<br /><br /><a href='$config[SITEURL]/download?id=%d'>Download Now</a><br /><a href='$config[SITEURL]/torrents/read?id=%d'>View Uploaded Torrent</a><br /><br />";
