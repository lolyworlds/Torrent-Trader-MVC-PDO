                    ...
                    if (array_key_exists("items", $faq_categ[$id])) {
                        foreach ($faq_categ[$id]['items'] as $id2 => $temp) {
                            if ($faq_categ[$id]['items'][$id2]['flag'] == "1") {
                                print("<li><a href=\"#section" . $id2 . "\">" . stripslashes($faq_categ[$id]['items'][$id2]['question']) . "</a></li>\n");
                            } elseif ($faq_categ[$id]['items'][$id2]['flag'] == "2") {
                                print("<li><a href=\"#section" . $id2 . "\">" . stripslashes($faq_categ[$id]['items'][$id2]['question']) . "</a> <img src=\"" . $config["SITEURL"] . "/images/faq/updated.png\" alt=\"Updated\" width=\"46\" height=\"13\" align=\"bottom\" /></li>\n");
                            } elseif ($faq_categ[$id]['items'][$id2]['flag'] == "3") {
                                print("<li><a href=\"#section" . $id2 . "\">" . stripslashes($faq_categ[$id]['items'][$id2]['question']) . "</a> <img src=\"" . $config["SITEURL"] . "/images/faq/new.png\" alt=\"New\" width=\"25\" height=\"12\" align=\"bottom\" /></li>\n");
                            }
    ...
    public function manage()
    {
        ...
        if (isset($faq_orphaned)) {
            ...
            foreach ($faq_orphaned as $id => $temp) {
                if ($faq_orphaned[$id]['flag'] == "0") {
                    $status = "<font color=\"#ff0000\">Hidden</font>";
                } elseif ($faq_orphaned[$id]['flag'] == "2") {
                    $status = "<font color=\"#0000FF\">Updated</font>";
                } elseif ($faq_orphaned[$id]['flag'] == "3") {
                    $status = "<font color=\"#008000\">New</font>";
                } else {
                    $status = "Normal";
                }
