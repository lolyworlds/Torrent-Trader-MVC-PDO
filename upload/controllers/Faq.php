...
if ($_GET["action"] == "reorder") {
 ...
 header("Refresh: 0; url=/faqmanage"); 
}
...
elseif ($_GET["action"] == "edit" && is_valid_id($_GET['id'])) {
 ...
 while ($arr = $res->fetch(PDO::FETCH_BOTH)) {
  ...
  if ($arr['type'] == "item") {
   print("<form method=\"post\" action=\"/faqactions?action=edititem\">");
  ...
  elseif ($arr['type'] == "categ") {
   print("<form method=\"post\" action=\"/faqactions?action=editsect\">");
...
elseif ($_GET['action'] == "delete" && isset($_GET['id'])) {
 if ($_GET['confirm'] == "yes") {
  ...
  print("<table border=\"0\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" width=\"95%\">\n<tr><td align=\"center\">Please click <a href=\"/faqactions?action=delete&amp;id=$_GET[id]&amp;confirm=yes\">here</a> to confirm.</td></tr>\n</table>\n");
  end_frame();
  stdfoot();
 }
}
...
elseif ($_GET['action'] == "additem" && $_GET['inid']) {
 ...
 print("<form method=\"post\" action=\"/faqactions?action=addnewitem\">");
 print("<table border=\"0\" cellspacing=\"0\" cellpadding=\"10\" align=\"center\">\n");
...
elseif ($_GET['action'] == "addsection") {
 ...
 print("<form method=\"post\" action=\"/faqactions?action=addnewsect\">");
 print("<table border=\"0\" class=\"table_table\" cellspacing=\"0\" cellpadding=\"10\" align=\"center\">\n");
...
else header("Refresh: 0; url=/faqmanage");
}
...
// print the faq table
 print("<form method=\"post\" action=\"/faqactions?action=reorder\">");
 ...
 foreach ($faq_categ as $id => $temp) {
  ...
  print("</select></td><td class=\"table_col2\" align=\"center\" width=\"40px\">&nbsp;</td><td class=\"table_col1\"><b>". stripslashes($faq_categ[$id]['title']) ."</b></td><td class=\"ttable_col2\" align=\"center\" width=\"60px\">". $status ."</td><td class=\"ttable_col1\" align=\"center\" width=\"60px\"><a href=\"/faqactions?action=edit&amp;id=". $id ."\">edit</a> <a href=\"/faqactions?action=delete&amp;id=". $id ."\">delete</a></td></tr>\n");
  ...
  if (array_key_exists("items", $faq_categ[$id])) {
   foreach ($faq_categ[$id]['items'] as $id2 => $temp) {
    ...
    print("</select></td><td class=\"ttable_col1\">". stripslashes($faq_categ[$id]['items'][$id2]['question']) ."</td><td class=\"table_col2\" align=\"center\" width=\"60px\">". $status ."</td><td class=\"ttable_col1\" align=\"center\" width=\"60px\"><a href=\"/faqactions?action=edit&amp;id=". $id2 ."\">edit</a> <a href=\"/faqactions?action=delete&amp;id=". $id2 ."\">delete</a></td></tr>\n");
   }
  }

  print("<tr><td colspan=\"5\" align=\"center\"><a href=\"/faqactions?action=additem&amp;inid=". $id ."\">Add new item</a></td></tr>\n");
  print("</table>\n");
 }
}
...
if (isset($faq_orphaned)) {
 ...
 foreach ($faq_orphaned as $id => $temp) {
  ...
  print("<tr><td>". stripslashes($faq_orphaned[$id]['question']) ."</td><td align=\"center\" width=\"60px\">". $status ."</td><td align=\"center\" width=\"60px\"><a href=\"/faqactions?action=edit&amp;id=". $id ."\">edit</a> <a href=\"/faqactions?action=delete&amp;id=". $id ."\">delete</a></td></tr>\n");
 }
 print("</table>\n");
}

print("<br />\n<table border=\"0\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" width=\"95%\">\n<tr><td align=\"center\"><a href=\"/faqactions?action=addsection\">Add new section</a></td></tr>\n</table>\n");
