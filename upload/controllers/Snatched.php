        ...
        if ($type == 'torrent') {
            ...
            if ($count_uid > 0) {
		    	...
		    	<table border="0" class="table_table" cellpadding="4" cellspacing="0" width="100%">
                    ...
                    $result = $query->fetch();
                    if ($result[0] == "yes") {$type = "<img src='images/t_extern.png' border='0' title='" . T_("EXTERNAL_TORRENT") . "'>";} else { $type = "<img src='images/t_local.png' border='0' title='" . T_("LOCAL_TORRENT") . "'>";}
                    if ($result[1] == 1) {$freeleech = "<img src='images/free.gif' border='0' title='" . T_("FREE") . "'>";} else { $freeleech = "";}
