...
// IMDB
    ...
    public function search()
    {
        ...
        ?>><?php echo T_("INC_DEAD"); ?></option>
                <option value="2" <?php if ($_GET["incldead"] == 2) {
            echo "selected='selected'";
        }
        ?>><?php echo T_("ONLY_DEAD"); ?></option>
                </select>
        ...
        ?>><?php echo T_("NOT_FREELEECH"); ?></option>
                <option value="2" <?php if ($_GET["freeleech"] == 2) {
            echo "selected='selected'";
        }
        ?>><?php echo T_("ONLY_FREELEECH"); ?></option>
                 </select>
            ...
            ?>><?php echo T_("LOCAL_ONLY"); ?></option>
                    <option value="2" <?php if ($_GET["inclexternal"] == 2) {
                echo "selected='selected'";
            }
            ?>><?php echo T_("EXTERNAL_ONLY"); ?></option>
                     </select>
                <?php }?>
